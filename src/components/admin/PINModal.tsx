...
import { Lock, Delete, X, Shield, Sparkles, ArrowLeft } from 'lucide-react';
...
export const PINModal: React.FC<PINModalProps> = ({
  ...
  return (
    ...
    >
      ...
      {/* Subtle close button to return to customer view */}
      {step !== 'intro' && (
        <button
          onClick={onClose}
          className="absolute top-6 right-6 z-30 p-2.5 rounded-full bg-white/10 hover:bg-white/20 text-white/95 transition-all duration-200 border border-white/10 backdrop-blur-md cursor-pointer shadow-lg active:scale-90"
        ...
        <AnimatePresence mode="wait">
          ...
          {step === 'pin' && (
            ...
            >
              ...
              {/* Sandbox Guide Badge */}
              <div className="mt-7 pt-4 border-t border-white/10 flex flex-col items-center">
                <span className="text-[9px] font-bold text-white/40 uppercase tracking-widest mb-1.5 flex items-center gap-1">
                ...
                <div className="flex gap-2 text-[10px] font-mono text-white/70">
                  ...
                  <span className="px-2 py-0.5 rounded-md bg-white/5 border border-white/10 text-amber-400 border-amber-500/20">
                    Manager: {ownerPin}
                  </span>
                </div>
              </div>
